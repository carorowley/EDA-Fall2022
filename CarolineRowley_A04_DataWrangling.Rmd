...
#I am not sure this is the correct structure command
```
...
EPA.PM25.2018.select <-
  EPA.PM25.2018 %>% 
  select(Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

EPA.PM25.2019.select <-
  EPA.PM25.2019 %>% 
  select(Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY:SITE_LONGITUDE)

#5

EPA.PM25.2018.select <- mutate(EPA.PM25.2018.select, AQS_PARAMETER_DESC = "PM2.5")

EPA.PM25.2019.select <- mutate(EPA.PM25.2019.select, AQS_PARAMETER_DESC = "PM2.5")

#6

EPAair_O3_NC2018_processed <- write.csv(EPA.o3.2018.Select, file = "./Data/Processed/EPAair_O3_NC2018_processed", row.names = FALSE)

EPAair_O3_NC2019_processed <- write.csv(EPA.o3.2019.select, file = "./Data/Processed/EPAair_O3_NC2019_processed", row.names = FALSE)

EPAair_PM25_NC2018_processed <- write.csv(EPA.PM25.2018.select, file = "./Data/Processed/EPAair_PM25_NC2018_processed", row.names = FALSE)

EPAair_PM25_NC2019_processed <- write.csv(EPA.PM25.2019.select, file = "./Data/Processed/EPAair_PM25_NC2019_processed", row.names = FALSE)
```
