...
```{r DataExercise-1a}
high.temps <- c(93, 73, 78, 85, 82, 78, 75, 73, 71, 76)
low.temps <- c(53, 48, 59, 61, 54, 51, 51, 52, 55, 55)
```
...
```{r DataExercise-1b}
fahrenheit_to_celsius <- function(high.temps) {(high.temps - 32) * 5/9}
high.temps.celsius <- fahrenheit_to_celsius(high.temps)
low.temps.celsius <- fahrenheit_to_celsius(low.temps)
view(low.temps)
```
...
```{r DataExercise-1c}
data_frame <- (high.temps, high.temps.celsius, low.temps, low.temps.celsius)
temperature.df <- data_frame(high.temps, high.temps.celsius, low.temps, low.temps.celsius)
```
